...
# Creación de funciones E(z) y D(z), a manera de prueba se ocuparan los valores de Planck 2016 para testear las funciones
...
def cosmological_parameters(cosmo_pars = dict()):
    h = cosmo_pars.get('h', params_P18['h'])
    ...
    return h, Om, Ob, Ov, ODE, OL, OK, wa, w0


def E_arb(z, cosmo_pars = dict()):
    h, Om, Ob, Ov, ODE, OL, Ok, wa, w0 = cosmological_parameters(cosmo_pars)
